...
export async function mountVendangeWorkspace(root: HTMLDivElement) {
  await initI18n()
...
const toolbarToggleBtn = app.querySelector('#toolbarToggle') as HTMLButtonElement
const toolbarEl = app.querySelector('#appToolbar') as HTMLElement
const uploadBtn = app.querySelector('#uploadBtn') as HTMLButtonElement
const themeToggleBtn = app.querySelector('#themeToggleBtn') as HTMLButtonElement
const shortcutBtn = app.querySelector('#shortcutBtn') as HTMLButtonElement
const uploadModal = app.querySelector('#uploadModal') as HTMLDivElement
const uploadDropzone = app.querySelector('#uploadDropzone') as HTMLDivElement
const uploadCloseBtn = app.querySelector('#uploadCloseBtn') as HTMLButtonElement
const uploadDismissBtn = app.querySelector('#uploadDismissBtn') as HTMLButtonElement
const uploadClearBtn = app.querySelector('#uploadClearBtn') as HTMLButtonElement
const shortcutModal = app.querySelector('#shortcutModal') as HTMLDivElement
const shortcutCloseBtn = app.querySelector('#shortcutCloseBtn') as HTMLButtonElement
const shortcutDoneBtn = app.querySelector('#shortcutDoneBtn') as HTMLButtonElement
const shortcutResetBtn = app.querySelector('#shortcutResetBtn') as HTMLButtonElement
const shortcutList = app.querySelector('#shortcutList') as HTMLDivElement

const origInput = app.querySelector('#origFile') as HTMLInputElement
const curInput = app.querySelector('#curFile') as HTMLInputElement
const exportBtn = app.querySelector('#exportBtn') as HTMLButtonElement
const languageSelect = app.querySelector('#languageSelect') as HTMLSelectElement
const uploadModalTitle = app.querySelector('#uploadModalTitle') as HTMLHeadingElement
const uploadInstructions = uploadModal.querySelector('.modal-instructions') as HTMLParagraphElement
const shortcutModalTitle = app.querySelector('#shortcutModalTitle') as HTMLHeadingElement
const shortcutInstructions = shortcutModal.querySelector('.modal-instructions') as HTMLParagraphElement
const clustersEl = app.querySelector('#clusters') as HTMLDivElement
const detailsEl = app.querySelector('#details') as HTMLDivElement
const dropHint = app.querySelector('#dropHint') as HTMLDivElement
...
function openExpressionFilterSelect() {
  const select = app.querySelector<HTMLSelectElement>('select.expression-filter-select')
