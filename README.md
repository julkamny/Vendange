...
- The editing surface now mirrors the pretty-printed view (colors, ARK label hover tooltips, highlighted background) and offers `@` autocompletion for controlled values and entities—type `@@` if you just need a literal `@`.
