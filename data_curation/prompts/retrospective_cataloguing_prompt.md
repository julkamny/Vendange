...
- La signification des sous-zones est la suivante :
...
245$k Formule de liaison
245$n Titre non indexé
...
- Quand un livre contient plusieurs zones 245 (résultat d'une erreur humaine), gardes-en une, et distribue l'information contenue par les autres dans des zones 438, réservées aux autres titres contenus dans le livre : 
...
- Un même agent peut avoir plusieurs codes-fonctions, s'il est responsable et de l'illustration ET de l'adaptation.
...
[
  {
    ...
    "manifestation_champ_245": 
    [
      dict,
    ],
    "agents":
    [
      {"nom": str,"codes_fonctions": [str,]}, 
      {"nom": str,"codes_fonctions": [str,]}, 
    ],
    "indications_édition": str,
    "zones_438":
    [
      dict,
      dict,
